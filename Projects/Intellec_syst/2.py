...
forth_fig = second_fig + spacing + width

spacingS = int(spacing + width / 2)
second_figS = spacingS + spacing + width
third_figSC = int(second_figS + width / 2)
forth_figS = third_figSC + spacing + width


# вывод фигур
cv2.rectangle(image, (spacing, first_layer), (first_fig, first_layer + width), (100, 0, 100), -1)
cv2.rectangle(image, (first_fig + spacing, first_layer), (second_fig, first_layer + width), (0, 255, 0), -1)
cv2.rectangle(image, (second_fig + spacing, first_layer), (third_fig, first_layer + width), (255, 0, 0), -1)

cv2.circle(image, (spacingC, second_layer), int(width / 2), (0, 0, 0), -1)
cv2.circle(image, (second_figC + spacingC, second_layer), int(width / 2), (0, 255, 255), -1)
cv2.circle(image, (third_figC + spacingC * 3, second_layer), int(width / 2), (255, 255, 0), -1)
